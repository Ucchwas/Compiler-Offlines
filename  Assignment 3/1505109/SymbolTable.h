...
class ScopeTable
{
     ...
     public:
		...
		a[sizeof(a) - 1] = 0;
                       ...
                       fprintf(logout,"%s",a);
                if(entry->value.c==0) fprintf(logout,"%d",entry->value.ival); 
                if(entry->value.c==1) fprintf(logout,"%f",entry->value.fval); 
                if(entry->value.c==2) { fprintf(logout,"{");
                       for(int i=0;i<entry->value.arraysize;i++) {
                       if(i!=entry->value.arraysize-1) fprintf(logout,"%d,",entry->value.iarray[i]);
                ...
                if(entry->value.c==3) { fprintf(logout,"{"); //cout<<"{";
                       for(int i=0;i<entry->value.arraysize;i++) {
                       if(i!=entry->value.arraysize-1) fprintf(logout,"%f,",entry->value.farray[i]);
                ...
                if(entry->para==1) { fprintf(logout,"{"); //cout<<"{";
                       ...
                       if(i!=entry->fsize-1) fprintf(logout,"%d,",entry->f[i]);
